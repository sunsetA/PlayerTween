...
CGINCLUDE
	...
	{				
		...
		baseColor.a = edgeBlendFactors.x * _BaseColor.a;
	...
	{		
		...
		baseColor.a = edgeBlendFactors.x * saturate(0.5 + refl2Refr * 1.0) * _BaseColor.a;
		UNITY_APPLY_FOG(i.fogCoord, baseColor);
		return baseColor;
	}	
	...
	{		
		...
		half4 baseColor = _BaseColor;
		baseColor = lerp(baseColor, _ReflectionColor, saturate(refl2Refr * 2.0));
		baseColor.a = saturate(2.0 * refl2Refr + 0.5) * _BaseColor.a;
